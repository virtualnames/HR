...
from Mutation import mutate_version, mutate_serial_number, mutate_issuer, mutate_validity, mutate_subject
from helpers import write_log1, save_certificate_der_1, save_private_key
...
def certificate_mutation(
    ...
    while completed_iterations < iteration_count:
        ...
        filename = f"Cert{timestamp}{completed_iterations}.der"
...
def main():
    ...
    INPUT_FOLDER = "./certs/input"
    SEED_FOLDER = "./certs/seed0"
    OUTPUT_FOLDER = "./certs/certs1"
    LOG_FILE = "./certs/log/certs1.txt"

    generate_choice = get_user_choice(
        "Generate a new initial certificate?  (y/n) ",
        ["y", "n"]
    )
