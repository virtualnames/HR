...
def display_extensions_menu():
    ...
    print("\nPlease select the certificate extension(enter a single number, enter 0 to exit):\n")
    extensions = [
...
if __name__ == "__main__":
    ...
    INPUT_DIR = "./certs/seeds1"
    INPUT_CERT_PATH = ""
    ROOT_CERT_PATH = "./certs/seed0/RootCA.der"
    KEY_PATH = "./certs/seed0/Private_key.pem"
    OUTPUT_DIR = "./certs/certs2"
    LOG_FILE = "./certs/log/certs2.txt"
    KEY_PASSPHRASE = None
